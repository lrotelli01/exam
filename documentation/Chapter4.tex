...
\hline
\textbf{p} & \textbf{Dist.} & \textbf{Max N (W$<$200ms)} & \textbf{Max N (W$<$1000ms)} & \textbf{W at N=5000 (ms)} & \textbf{Status} \\
\hline
0.3 & Lognormal & 1,200 & 1,200 & 829,577.91 & \textcolor{red}{STALLED} \\
0.3 & Uniform & 2,500 & 4,000 & 526,727.45 & \textcolor{red}{STALLED} \\
\hline
0.5 & Lognormal & 1,200 & 1,600 & 782,955.64 & \textcolor{red}{STALLED} \\
0.5 & Uniform & 3,000 & 5,000 & 960.93 & \textcolor{orange!80!black}{DEGRADED} \\
\hline
0.8 & Lognormal & 2,500 & 3,500 & 282,778.77 & \textcolor{red}{STALLED} \\
0.8 & Uniform & 5,000+ & 5,000+ & 154.14 & \textcolor{green!50!black}{OK} \\
\hline
\end{tabular}
}
...
Table~\ref{tab:throughput_detail} reports configurations in increasing load order and, for each $(p,\text{distribution})$ pair, stops at the first STALLED point. The overall throughput grows with load, while waiting time increases sharply under hotspot conditions.
